...
{
	public partial class SetEleDictWindow
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget GeneToAnno.SetEleDictWindow
			this.Name = "GeneToAnno.SetEleDictWindow";
			this.Title = global::Mono.Unix.Catalog.GetString ("Select Annotation Elements");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child GeneToAnno.SetEleDictWindow.VBox
			...
			w1.Add (this.labWindow);
			global::Gtk.Box.BoxChild w2 = ((global::Gtk.Box.BoxChild)(w1 [this.labWindow]));
			w2.Position = 0;
			// Internal child GeneToAnno.SetEleDictWindow.ActionArea
			...
			this.buttonOk.Clicked += new global::System.EventHandler (this.OnAccept);
		}
	}
}
